...
class ContactosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contacto" do
    assert_difference('Contacto.count') do
      post contactos_url, params: { contacto: { contact_id: @contacto.contact_id, email: @contacto.email, imagen: @contacto.imagen, name: @contacto.name, phone: @contacto.phone } }
    end
  ...
  test "should update contacto" do
    patch contacto_url(@contacto), params: { contacto: { contact_id: @contacto.contact_id, email: @contacto.email, imagen: @contacto.imagen, name: @contacto.name, phone: @contacto.phone } }
